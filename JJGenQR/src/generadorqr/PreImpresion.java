 ...
 * @author Jess
 */
public class PreImpresion extends javax.swing.JFrame {
//SwingController controlador;

    /**
     * Creates new form PreImpresion
     */
    public PreImpresion() {
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panel_reportes, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PreImpresion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PreImpresion().setVisible(true);
            }
        });
    }
